            ...
            <div className="flex-grow">
                <div className="grid grid-cols-3">
                    <div className="col-span-3 xl:col-span-2 flex flex-col justify-start">
                        <h1 className="font-jb-500 text-4xl md:text-6xl lg:text-7xl uppercase">
                ...
                <div className="pl-2 pt-3 grid grid-cols-3">
                    <div className="col-span-2 lg:col-span-1">
                        <p className="font-jb-200">{t("subheadline")}</p>
                    </div>
                </div>
            </div>
            <div className="self-start mt-auto w-full flex justify-center md:justify-start">
                <Button className="m-5 font-jb-200 text-1xl p-7 md:text-2xl md:p-10 rounded-full">{t("contact_us")}</Button>
            </div>
        </Section>
    );
}
